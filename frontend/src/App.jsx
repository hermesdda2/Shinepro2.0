    ...
    return (
      <div style={{
        ...
        <div style={{ marginBottom: '3rem', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          <img src="/logo.png" alt="Shine Pro Logo" className="logo-glow-anim"
          ...
          <div style={{
            ...
            marginTop: '0.5rem', fontWeight: 600, opacity: 0.8, textTransform: 'uppercase'
          }}>MOBILE AUTO SPA</div>
        </div>
        <div style={{ width: '220px' }}>
          <div style={{
            width: '100%', height: '6px', background: 'rgba(255,255,255,0.05)',
            borderRadius: '10px', overflow: 'hidden', border: '1px solid rgba(255,212,0,0.1)'
          }}>
            <div style={{
